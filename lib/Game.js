...
class Game {
  ...
  resolve (){
    if (this.checkWinner(this._playerX.items.join(";"))) {
      return "Game over. Result: player X wins the game!!";
    }

    if (this.checkWinner(this._playerO.items.join(";"))) {
